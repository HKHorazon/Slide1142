...
<img src="../../IMAGE/WebFull互動媒體/WebFull_06/WebFull_06_01.png" style="position: absolute; right: 60px; top: 150px; width: 300px; border-radius: 10px; box-shadow: 0 10px 20px rgba(0,0,0,0.5);" />
...
<img src="../../IMAGE/WebFull互動媒體/WebFull_06/WebFull_06_02.png" style="position: absolute; right: 60px; top: 150px; width: 300px; border-radius: 10px; box-shadow: 0 10px 20px rgba(0,0,0,0.5);" />
...
<img src="../../IMAGE/WebFull互動媒體/WebFull_06/WebFull_06_03.png" style="position: absolute; right: 60px; top: 250px; width: 500px; border-radius: 10px; box-shadow: 0 10px 20px rgba(0,0,0,0.5);" />
...
3.  **怎麼拿掉廣告？**
    -   付錢 (Upgrade to Premium)。(最終實作不需要付費)。
...
我們學了 Figma 的設計與 Wix 的實作搭建。
你可以結合 **AI 生成素材** + **Figma 排版** + **Wix 實作**，做出一個完整的網站。
